...
Public Class Sando
    ...
    Public Sub RefreshData()
        Try
            ...
            Me.CashingTableAdapter.Fill(Me.FinanceDataSet3.cashing)
            Me.CatchTableAdapter.Fill(Me.FinanceDataSet3._catch)
    ...
    Private Sub ChartControl35_Click(sender As Object, e As EventArgs)
