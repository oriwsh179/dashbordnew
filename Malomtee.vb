...
Public Class Malomtee
    ...
    Private Sub Chart_Bind_IELAM()
        Try
            ' 1. تحميل البيانات من الجدول
            Dim dt As New FinanceDataSet.F_SALAREDataTable
            Dim adapter As New FinanceDataSetTableAdapters.F_SALARETableAdapter()
            adapter.Fill(dt)
    ...
    Public Sub RefreshData()
        Try
            ...
            Me.CAR_ATableAdapter.Fill(Me.FinanceDataSet.CAR_A)
    ...
    Private Sub ChartControl36_Click(sender As Object, e As EventArgs) Handles ChartControl36.Click
